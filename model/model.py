...
class DynamoModel(nn.Module):
    """DYNAMO model integrating transformer, Time2Vec, and GNN for temporal-causal reasoning."""
    ...
    def forward(self,
        ...
        # Text embedding from transformer (using CLS token or equivalent)
        text_emb = self.transformer(input_ids, attention_mask=attention_mask).last_hidden_state[:, 0]  # [batch_size, hidden_dim]
        ...
        fused = self.fusion_layer(combined)  # [batch_size, fused_dim]
